...
import * as sty from "./PlasmicMenuButton.module.css"; // plasmic-import: OIZgoGMRx_l4AI/css

import BarsIcon from "./icons/PlasmicIcon__Bars"; // plasmic-import: xNdABSs419JhwK/icon
import TimesIcon from "./icons/PlasmicIcon__Times"; // plasmic-import: SIPpQAwfBPWmb6/icon
    ...
    >
      ...
      >
        {(hasVariant(variants, "expanded", "expanded") ? false : true) ? (
          <BarsIcon
            className={classNames(defaultcss.all, sty.svg___46EN0, {
              [sty.svg__expanded___46EN0M9JE]: hasVariant(
                variants,
                "expanded",
                "expanded"
              )
        ...
        {(hasVariant(variants, "expanded", "expanded") ? true : false) ? (
          <TimesIcon
            className={classNames(defaultcss.all, sty.svg__zOnPg, {
              [sty.svg__expanded__zOnPGm9JE]: hasVariant(
                variants,
                "expanded",
                "expanded"
              )
