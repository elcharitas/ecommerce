...
import * as sty from "./PlasmicFeatureItem.module.css"; // plasmic-import: U_D0s_be_wPIx/css
...
function PlasmicFeatureItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.freeBox__yzrvA)}>
        <div className={classNames(defaultcss.all, sty.freeBox__feBgu)} />

        <div className={classNames(defaultcss.all, sty.freeBox__o1Y5M)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox__inYg)}
          >
            <div
            ...
            <div className={classNames(defaultcss.all, sty.freeBox__kUn4C)}>
              <div
                className={classNames(
                  defaultcss.all,
                  defaultcss.__wab_text,
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox___1RxAc)}
            >
              <LinkButton
