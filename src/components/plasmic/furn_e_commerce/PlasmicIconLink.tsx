...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: 6OBa2O5qVaQ-kM/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__rw7H2)}
              role={"img"}
            />
          ),
