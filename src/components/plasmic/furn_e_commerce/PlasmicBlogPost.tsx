...
import * as sty from "./PlasmicBlogPost.module.css"; // plasmic-import: BgbcMKyT0yf__w/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__orW33, {
            [sty.freeBox__long__orW33PKhJc]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img__ig4LZ)}
                role={"img"}
                src={b1JZz2OqIIrcTjx}
              />
            ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__uxl2V, {
          [sty.freeBox__long__uxl2VpKhJc]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
